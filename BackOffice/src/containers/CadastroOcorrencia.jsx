...
//       console.log(`Ocorrência ${id ? "atualizada" : "criada"} com sucesso:`, result);
//       navigate("/"); // Redireciona para a home ou outra página após a operação
//     } catch (error) {
//       console.error(`Erro ao ${id ? "atualizar" : "criar"} a ocorrência:`, error);
//       setErrorMessage(`Erro ao ${id ? "atualizar" : "criar"} a ocorrência. Tente novamente.`);
//     }
//   };
...
//            {/* Passando o ID para o componente CadastroFotosOcorrencia */}
